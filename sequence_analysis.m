...
%% Ask user which part of the program he wishes to use

%addpath(['/Volumes/1378_BereiterLivio_BA_TSP_AutomatedProcessAnalysis/Program/sequence_analysis/Cath_feedback_V2']);
addpath('P:\04_Student_theses\1378_BereiterLivio_BA_TSP_AutomatedProcessAnalysis\Program\sequence_analysis\Cath_feedback_V2');
addpath('P:\04_Student_theses\1378_BereiterLivio_BA_TSP_AutomatedProcessAnalysis\Program\sequence_analysis\eye_track_seq');

prompt = 'Would you like to analyse surgery-sequences or eye-tracking-sequences?(INPUT:1 or 2 respectively)\n';
...
%publish('sequence_analysis.m','pdf')
